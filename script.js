...
// --------------------------------------------------------------------------
// [AJOUT] Dictionnaire des couleurs pour chaque catégorie
// --------------------------------------------------------------------------
const categoryColors = {
  "Thrift Store": "#ff0000",
  "Scrap Materials": "#00ff00",
  "Food": "#abcd00",
  "Exhibitions": "##300",
  "Markets": "#ff00ff"
};
...
// --------------------------------------------------------------------------
// [MODIFIÉ] Fonction loadMarkers() avec l’appel à createMarkerSVG(color)
// --------------------------------------------------------------------------
function loadMarkers() {
  const savedMarkers = getMarkersFromStorage();
  savedMarkers.forEach(markerData => {
    // Au lieu de mettre markerElement.innerHTML = markerSVG
    // on génère la couleur et le SVG dynamiquement :
    const markerElement = document.createElement('div');
    const color = getColorForCategory(markerData.category);
    markerElement.innerHTML = createMarkerSVG(color);

    // Utilise markerData.title, markerData.description, markerData.category
    const popupHTML = `
